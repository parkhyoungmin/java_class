...
-- # 가장 기본적인 데이터 추가
INSERT INTO coffees(cfid, cname, cprice) VALUES(1, '아이스아메리카노', 2000);
INSERT INTO coffees(cname, cfid, cprice) VALUES('뜨거운아메리카노', 2, 2000);
...
SELECT
    *
FROM emp;
-- 연습문제02: emp테이블에 employees의 모든 사원들 중 홀수 사번을 가진사원들만 추가해보세요
INSERT INTO 
    emp 
SELECT
    *
...
-- 연습문제03: emp테이블에 모든 사원들중 JoB_ID에 MAN이 포함된 사원들의 월급을 40%삭감 해보세요
UPDATE 
    emp 
SET 
    salary = salary * 0.4 
