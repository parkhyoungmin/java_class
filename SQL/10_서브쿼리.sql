...
SELECT * FROM employees WHERE salary > (SELECT MAX(salary) FROM employees WHERE department_id = 50); -- All->MAX,MIN과 같은 효과를 낸다
...
-- job_history테이블에 기록이 존재하는 사원을 보고 싶은 경우
SELECT
    *
FROM 
    employees 
