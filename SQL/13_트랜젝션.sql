...
/*
    # 트랜잭션 (Transaction)
        ...
        COMMIT -> UPDATE -> INSERT -> UPDATE -> COMMIT(OR ROLLBACK)
                    (DML만 가능)(UPDATE, INSERT, DELETE)
...
ROLLBACK;
ROLLBACK TO save01; -- 과거로만 돌아갈 수 있다, 먼저 생선된 SAVEPOINT로만 돌아갈 수 있다
