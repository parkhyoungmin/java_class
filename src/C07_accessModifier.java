...
public class C07_accessModifier extends C07_diffPackage{
	...
	public static void main(String[] args) {
		...
		System.out.println(same_package_instance.package_sInt);
		System.out.println(same_package_instance.protected_sInt);
		System.out.println(same_package_instance.public_sInt);
