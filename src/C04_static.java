...
public class C04_static {
	...
	/*
	 ...
	 - 같은 크래스의 모든 인스턴스가 공동으로 사용하는 영역
	 - static영역은 클래스 당 하나이기 때문에
	 	클래스 이름에 .을 찍고 사용하는 것이 권장된다
	 	(인스턴스에 .을찍고 사용해도 어차피 다 같은 값을 보기 때문에)
...
//		System.out.println(Card.height);
		...
		Card s1 = new Card("Spade", 1); // 스태틱 -> 인스턴스 -> constructor
		Card s2 = new Card("Spade", 2); // 스태틱 가장 처음 불리고 그이후에는 안 불림
