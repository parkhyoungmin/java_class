...
public class C02_OOP {
	...
	public static void main(String[] args) {
		...
		// Scanner 설계도로 실체를 만들어 그 실체의 주소를 변수 sc에 저장
...
//		   그 실체의 주소를 변수 apple01에 저장
		...
		// 모든 배열에 사과의 실체를 생성
		for(int i = 0; i < applebox.length; i++) { // applebox[0 ~ 9]
		...
		// 2. myobj.fruit 패키지에 클래스를 하나 정의하고 인스턴스를 생성해보세요
		
		// ※ 각 틀래스는 변수 3개 이상 메서드 1개이상
	}
}
