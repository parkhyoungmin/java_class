...
public class B13_Array {
	...
	public static void main(String[] args) {
		...
		a[1] = 55;
		a[99] = 1;		
//		a[100] = 99; (x) 100개를 만들었다면 인덱스는 99번 까지 있다
		...
		double[] scores = { // double타입일때 문제없이 들어갈수 있는것은 모두가능
				9.9, 8.8, 7.7, 6.6, 5.5, 4.4, 
				99, 'B', 123.123f, 300000000L
				};
		...
		// import java.util.Arrays 되어있다면 단축가능
		...
		System.out.println(msgArr[0]); // System.out.println(msg.charAt(0));
		...
		String[] list = {"apple", "banana", "orange", "peach", "kiwi"};
