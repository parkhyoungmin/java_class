...
public class D01_ArrayList {
	...
	/*
	 ...
	 - Collections 인터페이스를 구현한 클래스로드 List, Set이 있다
	 
	 # ArrayList
	 - 크기가 자동으로 조절되는 배열 클래스
	...
	public static void main(String[] args) {
		...
		// remove(index) : 원하는 아이템(요소, element)을 삭제 
//							(삭제하면서 삭제한 아이템을 반환)
		// remove(item) : 원하는 값을 모두 삭제
		System.out.println("삭제된 아이템 변환 " + list.remove(2));
		...
		// # 컬렉션은 Collection의 기능들을 사용할 수 있다
		// 개수 제한 없음
